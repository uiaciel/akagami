            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form onsubmit="return confirm('Are you sure?');" action="{{ route('crew.store') }}"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <select class="form-select" id="passport" disabled>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group mb-0">
                                                    ...
                                                    <span class="input-group-text" style=" width: 27%; " disabled>
                                                        歳</span>
                                                </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="passport_place" disabled>
                                            </div>
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-select" id="seaman" disabled>
                                            ...
                                            <label for="" class="col-sm-5">発給地<br>Issued Place</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="seaman_entry" disabled>
                                            </div>
                                            <label for="" class="col-sm-5">有効期限<br>Valid Until</label>
                                            <div class="col-sm-7">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="signoff" disabled>
                                    ...
                                    <div class="col-2">
                                        <img id="imgPreview" src="/storage/" src="/img/foto-4x6.png" alt="..."
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-select" id="orange" disabled>
                                            ...
                                            <label for="" class="col-sm-5">発給地<br>Issued Place</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="orange_entry" disabled>
                                            </div>
                                            <label for="" class="col-sm-5">有効期限<br>Valid Until</label>
                                            <div class="col-sm-7">
